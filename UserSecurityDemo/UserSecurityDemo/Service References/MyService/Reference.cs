...
// 
namespace UserSecurityDemo.MyService {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="", ConfigurationName="MyService.HelloService")]
    public interface HelloService {
        
        [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="urn:HelloService/HelloWorld", ReplyAction="urn:HelloService/HelloWorldResponse")]
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface HelloServiceChannel : UserSecurityDemo.MyService.HelloService, System.ServiceModel.IClientChannel {
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class HelloServiceClient : System.ServiceModel.ClientBase<UserSecurityDemo.MyService.HelloService>, UserSecurityDemo.MyService.HelloService {
        ...
        System.IAsyncResult UserSecurityDemo.MyService.HelloService.BeginHelloWorld(System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginHelloWorld(callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string UserSecurityDemo.MyService.HelloService.EndHelloWorld(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginHelloWorld(object[] inValues, System.AsyncCallback callback, object asyncState) {
            return ((UserSecurityDemo.MyService.HelloService)(this)).BeginHelloWorld(callback, asyncState);
        }
        
        private object[] OnEndHelloWorld(System.IAsyncResult result) {
            string retVal = ((UserSecurityDemo.MyService.HelloService)(this)).EndHelloWorld(result);
            return new object[] {
                    retVal};
        }
        ...
        protected override UserSecurityDemo.MyService.HelloService CreateChannel() {
            return new HelloServiceClientChannel(this);
        }
        
        private class HelloServiceClientChannel : ChannelBase<UserSecurityDemo.MyService.HelloService>, UserSecurityDemo.MyService.HelloService {
            
            public HelloServiceClientChannel(System.ServiceModel.ClientBase<UserSecurityDemo.MyService.HelloService> client) : 
                    base(client) {
            }
